<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:02569B,50:0288D1,100:00BCD4&height=260&section=header&text=Muhammad%20Azeem&fontSize=72&fontColor=fff&animation=fadeIn&fontAlignY=38&desc=Flutter%20Developer%20%7C%20Mobile%20App%20Engineer%20%7C%20BS%20Software%20Engineering&descAlignY=58&descSize=16"/>
</div>
...
<p align="center">
  <a href="https://www.linkedin.com/in/muhammad-azeem-9a593332a">
    <img src="https://img.shields.io/badge/LinkedIn-Muhammad%20Azeem-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
...
I'm a passionate **Flutter developer** and final-year **Software Engineering** student at **National Textile University, Faisalabad** (CGPA **3.32 / 4.0**, graduating **2026**). I love crafting clean, scalable, and real-time mobile applications — from AI-powered trip planners to digital art galleries.
...
An Android app to manage and display college events with **real-time data**. Features Firebase Authentication, categorized event sections *(Today, Upcoming, Important)*, in-app reminders, profile screen, and **dark mode toggle**.
...
A mobile platform for uploading, exploring, and interacting with digital artworks. Integrated **Firebase Auth**, Firestore for content management, and Cloudinary for media. Supports **likes, comments & view counts**.

</td>
<td width="33%" align="center">

### 🗺️ TrailMate
**Camping & Adventure Planner**

![Flutter](https://img.shields.io/badge/Flutter-02569B?style=flat&logo=flutter&logoColor=white)
![GetX](https://img.shields.io/badge/GetX-8B00FF?style=flat&logo=flutter&logoColor=white)
![REST API](https://img.shields.io/badge/REST_API-FF6C37?style=flat&logo=postman&logoColor=white)

A feature-rich trip planning app with **AI-assisted packing lists** and survival guidance via REST APIs. Built with GetX state management, Firestore, Cloudinary, and clean, reusable UI architecture.
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:00BCD4,50:0288D1,100:02569B&height=120&section=footer"/>
</div>
